...
<html>
    <head>
        ...
        <title>datasol | Headers Analysis</title>
        <link rel="stylesheet" href="headers-analysis.css">
    ...
    <body>
        <div class="hero">
            ...
            <h2>Analysis of HTTP headers</h2>
            ...
            <div class="box">
                <select id="myDropdown2">
                    ...
                    <option value="TTL Distribution Histogram">TTL Distribution Histogram of Web-Objects</option>
                    <option value="Max-Min Directives">Max-Stale and Min-Stale Directives Percentage</option>
                    <option value="Cacheability Directives">Cacheability Directives Percentage</option>
                </select>
            </div>
